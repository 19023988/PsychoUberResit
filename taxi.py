          ...
          while len(expanded) > 0:
              ...
              if nextNode[0] not in explored:
                  ...
                  while len(expansionTargets) > 0:
                      ...
                      trafficProb = (self._world.getNode(nextNode[0][0], nextNode[0][1])._traffic / self._world.getNode(
                          nextNode[0][0], nextNode[0][1])._trafficMax)
                      trafficMultiplier = 1 + trafficProb

                      estimatedDistance = bestPath - heuristic(nextNode[0], destination) + heuristic(expTgt[0],
                                                                                                     destination) + \
                                          expTgt[1][1] * trafficMultiplier
